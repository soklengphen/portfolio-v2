...
const TimelineSection = () => {
  ...
  const experienceItems: TimelineItem[] = [
    ...
    },
    {
      ...
      location: "Time Tower Building 4 floor, Toul Tompong, Phnom Penh",
      description:
        "Developed and build web applications for AYL Program",
      highlights: [
        "Training on Problem Identification, User Research, Design Thinking and Thematic Analysis ",
        "Developed and Design Web Application for Project name FRINT",
        "FRINT is help student well prepared for their future career interview",
      ],
      icon: <Code className="w-5 h-5" />,
      category: "experience",
    },
    ...
    },
    {
      ...
      location: "Chruu Chongva, Phnom Penh, Cambodia",
      icon: <Book className="w-5 h-5" />,
      category: "education",
      highlights: [
        "Completed course UI/UX Design, Frontend Development, Backend Development, and Devops",
