      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 py-12 md:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Building digital experiences that make an impact. Specialized in
              modern web technologies and passionate about creating intuitive,
              high-performance applications. Always eager to learn and explore
              new technologies.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <a href="/Phen_Sokleng.pdf" download>
                  View CV
                </a>
              </motion.button>
            </motion.div>
